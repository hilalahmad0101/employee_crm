...
onMounted(() => {
    form.company_name = props.company.name;
...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <div class="m-2 p-4">
            <Card class="p-10">
                <div class="space-y-6">
                    <HeadingSmall title="Update  company"
                        description="Update company to your system with basic information" />
                    ...
                    <form @submit.prevent="updateCompany" class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            <Button :disabled="form.processing">Update company</Button>
