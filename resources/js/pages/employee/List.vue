...
const companies = ref<Company[]>([
    { id: 1, name: 'Name1', email: 'admin@gmail.com' },
    { id: 2, name: 'TechCorp Solutions', email: 'admin@gmail.com' },
    { id: 3, name: 'Digital Innovations', email: 'admin@gmail.com' },
    { id: 4, name: 'Global Systems', email: 'admin@gmail.com' },
    { id: 5, name: 'Future Technologies', email: 'admin@gmail.com' },
]);
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            <!-- Dashboard Title -->
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Employee List</h1>
            </div>
